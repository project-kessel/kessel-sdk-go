...
func (UnimplementedKesselInventoryServiceServer) CheckSelf(context.Context, *CheckSelfRequest) (*CheckSelfResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CheckSelf not implemented")
}
...
func (UnimplementedKesselInventoryServiceServer) CheckSelfBulk(context.Context, *CheckSelfBulkRequest) (*CheckSelfBulkResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CheckSelfBulk not implemented")
}
...
func (UnimplementedKesselInventoryServiceServer) StreamedListObjects(*StreamedListObjectsRequest, grpc.ServerStreamingServer[StreamedListObjectsResponse]) error {
	return status.Error(codes.Unimplemented, "method StreamedListObjects not implemented")
}
func (UnimplementedKesselInventoryServiceServer) StreamedListSubjects(*StreamedListSubjectsRequest, grpc.ServerStreamingServer[StreamedListSubjectsResponse]) error {
	return status.Error(codes.Unimplemented, "method StreamedListSubjects not implemented")
}
...
func RegisterKesselInventoryServiceServer(s grpc.ServiceRegistrar, srv KesselInventoryServiceServer) {
	// If the following call panics, it indicates UnimplementedKesselInventoryServiceServer was
