...
const file_buf_validate_priv_private_proto_rawDesc = "" +
	...
	"expression:\\\n" +
	"\x05field\x12\x1d.google.protobuf.FieldOptions\x18\x88\t \x01(\v2#.buf.validate.priv.FieldConstraintsR\x05field\x88\x01\x01Bw\n" +
	"\x17build.buf.validate.privB\fPrivateProtoP\x01ZLbuf.build/gen/go/bufbuild/protovalidate/protocolbuffers/go/buf/validate/privb\x06proto3"
