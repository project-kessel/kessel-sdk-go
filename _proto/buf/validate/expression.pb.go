...
const file_buf_validate_expression_proto_rawDesc = "" +
	...
	"\afor_key\x18\x04 \x01(\bR\x06forKeyBp\n" +
	"\x12build.buf.validateB\x0fExpressionProtoP\x01ZGbuf.build/gen/go/bufbuild/protovalidate/protocolbuffers/go/buf/validateb\x06proto3"
