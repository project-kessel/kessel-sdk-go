...
const file_google_type_expr_proto_rawDesc = "" +
	"\n" +
	"\x16google/type/expr.proto\x12\vgoogle.type\"z\n" +
	"\x04Expr\x12\x1e\n" +
	"\n" +
	...
	"\blocation\x18\x04 \x01(\tR\blocationBZ\n" +
	"\x0fcom.google.typeB\tExprProtoP\x01Z4google.golang.org/genproto/googleapis/type/expr;expr\xa2\x02\x03GTPb\x06proto3"

var (
	file_google_type_expr_proto_rawDescOnce sync.Once
	file_google_type_expr_proto_rawDescData []byte
)

func file_google_type_expr_proto_rawDescGZIP() []byte {
	file_google_type_expr_proto_rawDescOnce.Do(func() {
		file_google_type_expr_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_type_expr_proto_rawDesc), len(file_google_type_expr_proto_rawDesc)))
	})
...
func file_google_type_expr_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_type_expr_proto_rawDesc), len(file_google_type_expr_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
