...
type QuotaFailure_Violation struct {
	...
	// empty.
	QuotaDimensions map[string]string `protobuf:"bytes,6,rep,name=quota_dimensions,json=quotaDimensions,proto3" json:"quota_dimensions,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
const file_google_rpc_error_details_proto_rawDesc = "" +
	...
	"\vapi_service\x18\x03 \x01(\tR\n" +
	"apiService\x12!\n" +
	"\fquota_metric\x18\x04 \x01(\tR\vquotaMetric\x12\x19\n" +
	"\bquota_id\x18\x05 \x01(\tR\aquotaId\x12b\n" +
	"\x10quota_dimensions\x18\x06 \x03(\v27.google.rpc.QuotaFailure.Violation.QuotaDimensionsEntryR\x0fquotaDimensions\x12\x1f\n" +
	"\vquota_value\x18\a \x01(\x03R\n" +
	"quotaValue\x121\n" +
	"\x12future_quota_value\x18\b \x01(\x03H\x00R\x10futureQuotaValue\x88\x01\x01\x1aB\n" +
	...
	"\x11localized_message\x18\x04 \x01(\v2\x1c.google.rpc.LocalizedMessageR\x10localizedMessage\"O\n" +
...
func file_google_rpc_error_details_proto_init() {
	...
	file_google_rpc_error_details_proto_msgTypes[11].OneofWrappers = []any{}
	type x struct{}
