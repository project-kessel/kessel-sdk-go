...
const file_kessel_inventory_v1_health_proto_rawDesc = "" +
	"\n" +
	...
	"\tGetReadyz\x12%.kessel.inventory.v1.GetReadyzRequest\x1a&.kessel.inventory.v1.GetReadyzResponse\" \x82\xd3\xe4\x93\x02\x1a\x12\x18/api/inventory/v1/readyzB\xd5\x01\n" +
	"\x17com.kessel.inventory.v1B\vHealthProtoP\x01Z?github.com/project-kessel/inventory-api/api/kessel/inventory/v1\xa2\x02\x03KIX\xaa\x02\x13Kessel.Inventory.V1\xca\x02\x13Kessel\\Inventory\\V1\xe2\x02\x1fKessel\\Inventory\\V1\\GPBMetadata\xea\x02\x15Kessel::Inventory::V1b\x06proto3"

var (
	file_kessel_inventory_v1_health_proto_rawDescOnce sync.Once
	file_kessel_inventory_v1_health_proto_rawDescData []byte
)

func file_kessel_inventory_v1_health_proto_rawDescGZIP() []byte {
	file_kessel_inventory_v1_health_proto_rawDescOnce.Do(func() {
		file_kessel_inventory_v1_health_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_kessel_inventory_v1_health_proto_rawDesc), len(file_kessel_inventory_v1_health_proto_rawDesc)))
	})
...
var file_kessel_inventory_v1_health_proto_goTypes = []any{
	(*GetLivezRequest)(nil),   // 0: kessel.inventory.v1.GetLivezRequest
	(*GetLivezResponse)(nil),  // 1: kessel.inventory.v1.GetLivezResponse
	(*GetReadyzRequest)(nil),  // 2: kessel.inventory.v1.GetReadyzRequest
	(*GetReadyzResponse)(nil), // 3: kessel.inventory.v1.GetReadyzResponse
}
var file_kessel_inventory_v1_health_proto_depIdxs = []int32{
	0, // 0: kessel.inventory.v1.KesselInventoryHealthService.GetLivez:input_type -> kessel.inventory.v1.GetLivezRequest
	2, // 1: kessel.inventory.v1.KesselInventoryHealthService.GetReadyz:input_type -> kessel.inventory.v1.GetReadyzRequest
	1, // 2: kessel.inventory.v1.KesselInventoryHealthService.GetLivez:output_type -> kessel.inventory.v1.GetLivezResponse
	3, // 3: kessel.inventory.v1.KesselInventoryHealthService.GetReadyz:output_type -> kessel.inventory.v1.GetReadyzResponse
...
func file_kessel_inventory_v1_health_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_kessel_inventory_v1_health_proto_rawDesc), len(file_kessel_inventory_v1_health_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
