...
const file_kessel_inventory_v1beta2_streamed_list_objects_response_proto_rawDesc = "" +
	...
	"pagination\x12W\n" +
	"\x11consistency_token\x18\x03 \x01(\v2*.kessel.inventory.v1beta2.ConsistencyTokenR\x10consistencyTokenB\x88\x02\n" +
	"\x1ccom.kessel.inventory.v1beta2B StreamedListObjectsResponseProtoP\x01ZDgithub.com/project-kessel/inventory-api/api/kessel/inventory/v1beta2\xa2\x02\x03KIX\xaa\x02\x18Kessel.Inventory.V1beta2\xca\x02\x18Kessel\\Inventory\\V1beta2\xe2\x02$Kessel\\Inventory\\V1beta2\\GPBMetadata\xea\x02\x1aKessel::Inventory::V1beta2b\x06proto3"
